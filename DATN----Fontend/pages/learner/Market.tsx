                ...
                recs.map((course) => (
                  <div key={course._id} className="min-w-[320px] md:min-w-[420px] snap-start bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-[2.5rem] border border-blue-500/10 hover:border-blue-500/40 transition-all p-8 relative overflow-hidden group shadow-2xl flex flex-col justify-between">
                    ...
                    <div className="relative z-10 space-y-4 flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {course.level && (
                            <span className={`text-[9px] font-black px-2.5 py-1 rounded-lg uppercase tracking-tighter border ${
                              course.level === 'Hard' ? 'bg-red-500/15 border-red-500/30 text-red-400'
                              : course.level === 'Medium' ? 'bg-yellow-500/15 border-yellow-500/30 text-yellow-400'
                      ...
                      {/* Title */}
                      <h3 className="text-xl font-black leading-tight line-clamp-2 group-hover:text-blue-400 transition-colors">{course.title}</h3>
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-slate-400 text-xs font-bold">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-emerald-400 font-black">{course.studentCount || 0}</span>
                          <span className="text-slate-500">học viên</span>
                        </div>
                        {course.weeklyDownloads > 0 && (
                          <div className="flex items-center gap-1.5">
                            <Flame size={12} className="text-orange-400" />
                            <span className="text-orange-400 font-black">{course.weeklyDownloads}</span>
                        ...
                        {course.avgRating > 0 && (
                          <div className="flex items-center gap-1 text-amber-400 bg-amber-400/10 px-2 py-1 rounded-lg border border-amber-400/20">
                            ...
                            <span className="font-black">{course.avgRating}</span>
                          </div>
                        )}
                      </div>
                      ...
                      {/* Instructor badge */}
                      {course.instructorId && (
                        <div className="flex items-center gap-2 px-3 py-2 bg-purple-500/5 border border-purple-500/15 rounded-xl">
                      ...
                      <div className="flex items-center gap-3 pt-3 border-t border-white/5">
                        <div className="w-7 h-7 bg-slate-800 rounded-full flex items-center justify-center font-bold text-[10px] border border-slate-700 shrink-0">
                          {course.owner?.fullName?.[0]}
                        </div>
